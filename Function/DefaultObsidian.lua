...
local function startFly()
	...
	RunService:BindToRenderStep("Fly", 201, function()
		if not flying or not flyVel or not hrp then return end
		...
		local speed = (Options.FlySlider and Options.FlySlider.Value) or 50
...
function Library:CreatePlayerTab(parentTab)
    ...
    -- Speed
    Toggles.SpeedToggle = PlayerGroup:AddToggle("SpeedToggle", {
        Text = "Enable Speed",
        Default = false,
        Callback = function(v)
            humanoid.WalkSpeed = v and (Options.SpeedSlider and Options.SpeedSlider.Value or 16) or 16
        end
    })
    Options.SpeedSlider = PlayerGroup:AddSlider("SpeedSlider", {
        Text = "Speed Value",
        Default = 16,
        Min = 16,
        Max = 200,
    ...
    -- Jump
    Toggles.JumpToggle = PlayerGroup:AddToggle("JumpToggle", {
        Text = "Enable Jump",
        Default = false,
        Callback = function(v)
            humanoid.JumpPower = v and (Options.JumpSlider and Options.JumpSlider.Value or 50) or 50
        end
    })
    Options.JumpSlider = PlayerGroup:AddSlider("JumpSlider", {
        Text = "Jump Power",
        Default = 50,
        Min = 50,
        Max = 500,
    ...
    -- Fly
    Toggles.FlyToggle = PlayerGroup:AddToggle("FlyToggle", {
        Text = "Enable Fly",
        Default = false,
        Callback = function(v)
    ...
    Options.FlySlider = PlayerGroup:AddSlider("FlySlider", {
        Text = "Fly Speed",
        Default = 50,
        Min = 50,
        Max = 500
